...
function makeDeck(diff, symbols) {
...
function saveBest(mode, diff, secs) {
...
function MemoryCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      ...
      "aria-label": matched ? `Matched ${card.symbol}` : active ? `Flipped ${card.symbol}` : "Hidden card",
      onClick: () => !locked && !matched && !flipped && onClick(card.id),
      "data-ocid": "game.card",
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: innerClass, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card-face card-front", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card-face card-back", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "emoji-display", "aria-hidden": "true", children: card.symbol }) })
      ] })
    }
  );
}
function App() {
  const INIT_DIFF = "easy";
  const INIT_MODE = "default";
  const [difficulty, setDifficulty] = reactExports.useState(INIT_DIFF);
  const [gameMode, setGameMode] = reactExports.useState(INIT_MODE);
  const _initDeckRef = reactExports.useRef([]);
  ...
  const [matchedIds, setMatchedIds] = reactExports.useState(/* @__PURE__ */ new Set());
  const [popIds, setPopIds] = reactExports.useState(/* @__PURE__ */ new Set());
  const [revealIds, setRevealIds] = reactExports.useState(
  ...
  const [timerOn, setTimerOn] = reactExports.useState(false);
  const [gameStarted, setGameStarted] = reactExports.useState(false);
  const [status, setStatus] = reactExports.useState("Press Start Game to begin.");
  const [customInput, setCustomInput] = reactExports.useState(
    "⚽ 🥅 👟 👕 🧤 🏆 🟥 🟨 🎽 📣 🧢 🎯 🏟️ 🚩 🧃 🧊 💪 🔥"
  );
  const [bestDisplay, setBestDisplay] = reactExports.useState(() => {
    const b = getBest(INIT_MODE, INIT_DIFF);
    return b !== null ? formatTime(b) : "--";
  });
  const [winState, setWinState] = reactExports.useState(null);
  const timerRef = reactExports.useRef(null);
  const mountRevealDone = reactExports.useRef(false);
  reactExports.useEffect(() => {
  ...
  const refreshBest = reactExports.useCallback((mode, diff) => {
    const b = getBest(mode, diff);
    setBestDisplay(b !== null ? formatTime(b) : "--");
  }, []);
  const parseCustom = reactExports.useCallback(() => {
    const unique = [
      ...new Set(
        customInput.trim().split(/[\s,]+/).map((t) => t.trim()).filter(Boolean)
      )
    ];
  ...
  const newGame = reactExports.useCallback(
    (reveal = true) => {
      const symbols = gameMode === "custom" ? parseCustom() : SYMBOLS[difficulty];
      if (!symbols) return;
      if (timerRef.current) clearInterval(timerRef.current);
      setTimerOn(false);
      setElapsed(0);
      setMoves(0);
      setFlippedIds([]);
      setMatchedIds(/* @__PURE__ */ new Set());
      setPopIds(/* @__PURE__ */ new Set());
      setRevealIds(/* @__PURE__ */ new Set());
      setLocked(false);
      setWinState(null);
  ...
  const onCardClick = reactExports.useCallback(
    (id) => {
      ...
      if (cardA.symbol === cardB.symbol) {
        const newMatched = /* @__PURE__ */ new Set([...matchedIds, idA, idB]);
        setPopIds(/* @__PURE__ */ new Set([idA, idB]));
        setTimeout(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      style: {
        minHeight: "100vh",
        background: "radial-gradient(circle at 12% 10%, #3a2d95 0%, transparent 38%), radial-gradient(circle at 88% 8%, #1a6fab 0%, transparent 42%), linear-gradient(170deg, #0f0f2e, #0e2456)",
        display: "flex",
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "main",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { style: { textAlign: "center", marginBottom: "16px" }, children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { margin: "6px 0 0", fontSize: "0.9rem", opacity: 0.75 }, children: "Flip cards, match football-themed pairs, and beat your best time." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "section",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "0.85rem" }, children: "⏱️ Time:" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "strong",
                            {
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "0.85rem" }, children: "🕹️ Moves:" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { style: { color: warnYellow }, "aria-live": "polite", children: moves })
                        ]
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "select",
                            {
                              ...
                              style: selectStyle,
                              children: Object.keys(DIFFICULTY_LABELS).map((d) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: d, style: { background: "#0f1535" }, children: DIFFICULTY_LABELS[d] }, d))
                            }
                          )
                        ]
                      }
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            "select",
                            {
                              ...
                              onChange: (e) => {
                                ...
                                setStatus(
                                  m === "custom" ? "Enter emojis, then press Start Game." : "Default mode selected. Press Start Game."
                                );
                              },
                              style: selectStyle,
                              children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "default", style: { background: "#0f1535" }, children: "Default emojis" }),
                                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "custom", style: { background: "#0f1535" }, children: "Custom emojis" })
                              ]
                            }
                          )
                        ]
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "0.85rem" }, children: "🏆 Best:" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "strong",
                            {
              ...
              gameMode === "custom" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "section",
                {
                  className: "glass",
                  style: {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "p",
                      {
                        ...
                        children: [
                          "Custom mode needs ",
                          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: pairCount }),
                          " unique emojis for",
                          " ",
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "p",
                      {
                        ...
                        children: [
                          "Tap two cards to flip and reveal emojis. Matching pairs stay face up. If they do not match, they flip back after ~1 second. Match all pairs to win! ",
                          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Custom emojis:" }),
                          " enter unique emojis separated by spaces."
                        ]
                      }
                    )
                  ]
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "section",
                {
                  ...
                  children: deck.map((card, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    MemoryCard,
                    {
                      card,
        ...
        winState && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "dialog",
          {
            open: true,
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { margin: "0 0 6px", fontSize: "1rem" }, children: [
                    "Finished in ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: formatTime(winState.time) }),
                    " with",
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: winState.moves }),
                    " moves."
                  ] }),
                  winState.isNew ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      style: {
                        color: accentGreen,
                    ...
                    "p",
                    {
                      ...
                      children: [
                        "Best:",
                        " ",
                        winState.prevBest !== null ? formatTime(winState.prevBest) : "--"
                      ]
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
